...
// Code Here
let myNumbersIndex = [];
myNumbers.forEach((e, i, a) => myNumbersIndex.push(i))
...
// Code Here
let enemies = people.filter(n => n.friend === false)
...
// Code Here
let totallyAwesome = people.reduce((a, c) => {if(a.awesomeLevel.typeof === 'number'){a.awesomeLevel + c} else {a + c}})